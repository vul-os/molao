      ...
      <div className="w-full max-w-7xl mx-auto flex items-center h-16 px-4">
        ...
        <div className="flex items-center space-x-2">
          <a href="/" className="flex items-center space-x-2">
            <img src={Logo} alt="StorNxtDoor" className="h-8 w-8" />
            <h1 className="text-xl font-bold text-blue-600">StorNxtDoor</h1>
          </a>
        </div>
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <a href="https://twitter.com/StorNxtDoor" className="text-base text-gray-500 hover:text-gray-900">
                  Twitter
                </a>
              </li>
              <li>
                <a href="https://facebook.com/StorNxtDoor" className="text-base text-gray-500 hover:text-gray-900">
                  Facebook
                </a>
              </li>
              <li>
                <a href="https://instagram.com/StorNxtDoor" className="text-base text-gray-500 hover:text-gray-900">
                  Instagram
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {new Date().getFullYear()} StorNxtDoor. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
