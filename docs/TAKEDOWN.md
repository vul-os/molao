...
run one. [GOVERNANCE.md](../GOVERNANCE.md) already states the position honestly
...
| **The project** | No legal entity, no instrument, nothing to serve an order on ([GOVERNANCE.md](../GOVERNANCE.md)). | Can change the software. Cannot change any copy in anyone's hands. |
...
[GOVERNANCE.md](../GOVERNANCE.md) observes that forward-only compliance "is the
...
exactly the position [GOVERNANCE.md](../GOVERNANCE.md) says the project has no
...
compliance, described accurately in [GOVERNANCE.md](../GOVERNANCE.md), and the
...
9. Given that a Molao signature attests only that you rebuilt a release and got
   ...
   ([GOVERNANCE.md](../GOVERNANCE.md)) — would signing a release containing a
